...
def get_agent_tools(chroma_path: str = "./chroma_db", collection_name: str = "kohler_agent", llm=None):
    ...
    return [catalog_tool, calculator_tool, inventory_tool, aesthetic_tool]

__all__ = ["get_agent_tools", "calculator_tool", "inventory_tool", "get_catalog_tool", "aesthetic_tool"]
