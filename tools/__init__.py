...
from .aesthetic_matcher import aesthetic_tool
from .space_optimizer import space_optimizer_tool
...
def get_agent_tools(chroma_path: str = "./chroma_db", collection_name: str = "kohler_agent", llm=None):
    ...
    return [catalog_tool, calculator_tool, inventory_tool, aesthetic_tool, space_optimizer_tool]
